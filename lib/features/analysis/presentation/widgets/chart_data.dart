...
class BarChartSample2 extends StatefulWidget {
  ...
  final Color leftBarColor = AppColors.caribbeanGreen;
  final Color rightBarColor = AppColors.oceanBlue;
  final Color avgColor = AppColors.oceanBlue.avg(AppColors.lightGreen);
  @override
    ...
    return BarChart(
      BarChartData(
        ...
        borderData: FlBorderData(
          show: true,
          border: Border(bottom: BorderSide(color: AppColors.textGreenColor)),
        ),
