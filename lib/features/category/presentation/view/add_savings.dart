...
class AddSavingsScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<AddSavingsScreen> createState() => _AddExpenseScreenState();
}

class _AddExpenseScreenState extends ConsumerState<AddSavingsScreen> {
  ...
  Widget _buildCategoryDropdown(WidgetRef ref) {
    ...
    return categoryState.when(
      data: (categories) => DropdownButtonFormField<String>(
        ...
        items: categories
            .where((cat) => cat.categoryType == CategoryType.savings)
            .map((category) {
